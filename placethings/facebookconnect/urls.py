...
from placethings.facebookconnect.views import facebook_login,facebook_logout,setup
...
urlpatterns = patterns('',
    ...
    url(r'^xd_receiver.htm$',
        direct_to_template,
        {'template': 'placethings/facebookconnect/templates/facebook/xd_receiver.htm'},
